<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="操作者" prop="createBy" label-width="auto">
        <el-input
    ...
    <el-dialog :title="title" v-model="open" width="900px" append-to-body>
      <el-form :inline="true" ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item v-if="form.outboundId != undefined" label="出库编号" prop="outboundId">
          <el-input style="width: 250px" v-model="form.outboundId" disabled/>
        </el-form-item>
        ...
        <el-form-item v-if="form.updateId != undefined" label="更新者编号" prop="updateId">
          <el-input style="width: 250px" v-model="form.updateId" disabled/>
        </el-form-item>
        <el-form-item label="出库状态" prop="status">
        ...
        >
          ...
          <el-table-column label="数量" align="center" prop="count" width="150">
            <template #default="scope">
              <el-input v-model="scope.row.count" placeholder="请输入出库数量" />
            </template>
          </el-table-column>
